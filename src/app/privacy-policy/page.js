...
const PrivacyPolicy = () => {
  return (
    ...
    <div className="max-w-4xl mx-auto p-4">
      <h1 className="text-2xl font-bold text-center mb-4">Privacy Policy for Codewithsundeep.com</h1>
      <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from Codewithsundeep.com (the “Site”).</p>
      ...
      <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at <a href="mailto:codewithsundeep@gmail.com" className="text-blue-500">codewithsundeep@gmail.com</a>.</p>
    </div>
    <Footer/>
    </>
  );
